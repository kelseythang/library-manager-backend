...
Book.create([
  ...
  { title: 'Harry Potter and the Deathly Hallows', is_checked_out: false, isbn: 9780545010221, author_id: 2, genre_id: 2 },
  ...
  { title: 'The Silmarillion', is_checked_out: false, isbn: 9780544338012, author_id: 3 , genre_id: 1},
  { title: 'Unfinished Tales of Numenor and Middle-Earth', is_checked_out: false, isbn: 9780544337992, author_id: 3, genre_id: 1 },
  { title: 'The Children of Hurin', is_checked_out: false, isbn: 9780618894642, author_id: 3, genre_id: 1 },
  ...
  { title: 'Chapterhouse: Dune', is_checked_out: false, isbn: 9780593098271, author_id: 4, genre_id: 6 },
...
checkout_history = [[1, 1],[1, 2],[1, 3]]

checkout_history.each do |member, book|
